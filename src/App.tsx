  ...
  return (
    <>
      <div className="relative w-full">
        ...
        <div className="flex  mx-28 p-2 bg-gray-100  mt-24 mb-16">
          {/* Image */}
          <div> <img src="/src/assets/MAILLOT_DETE_Bleu_KX1258_000_plp_model.webp" alt=""  className="scale-110"/> </div>

          {/* Text */}
          <div className="flex mx-auto font-mono font-bold"><h3 className="text-black text-2xl">Personnalisation sur mesure</h3></div>
        </div>

        {/* Full Image d'une Tendance avec Call to Action pour achats */}
        <div className="bg-gray-200 py-80  mt-24 mb-8 ">
    ...
    <div className="group flex flex-col bg-white rounded-lg overflow-hidden border border-gray-100 hover:shadow-md transition-shadow">
      ...
      <div className="p-3 flex flex-col flex-grow">
        ...
        <p className="text-sm font-medium text-zinc-800 line-clamp-2 flex-grow">Description du produits</p>
        <button className="btn  border-2 border-green-200 btn-success btn-soft mt-4 mb-2">Acheter</button>
      </div>
    </div>
...
{/* NOS OFFRES POUR LES ENTREPRISES */}
  ...
  <aside>
    ...
    <p className="text-sm font-normal text-gray-500 pl-1">vous connectez a vos opportunites</p>
    </p>
      </div>
  ...
  <nav>
    ...
    <a className="link link-hover font-semibold text-gray-500">Repographie</a>
    <a className="link link-hover font-semibold text-gray-500">Design</a>
    <a className="link link-hover font-semibold text-gray-500">Marketing</a>
    <a className="link link-hover font-semibold text-gray-500">Inforatique</a>
  </nav>
  <nav>
    <h6 className="text-md font-black uppercase ">FILON PRINT</h6>
    <a className="link link-hover font-semibold text-gray-500 ">A Propos de Nous</a>
    <a className="link link-hover font-semibold text-gray-500">Nous Contacter</a>
    <a className="link link-hover font-semibold text-gray-500">Fourniture</a>
  </nav>

     <div className="flex flex-col  gap-4 ">
      <div><p className="text-md font-black">NOS RESEAUX</p></div>
